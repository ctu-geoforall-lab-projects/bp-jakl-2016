...
%%% ML: rady? nejedna se o slovniky - dictionary, respektive slovníky s řazením klíčových slov? Zkuste preformulovat
...
\subsection{Knihovna GDAL} %%% ML: dnes se oznacuje spis jako GDAL a ne GDAL/OGR
\label{GDAL/OGR}
...
%%% ML: vsechny nasledujici vety zacinaji na Je, zkusil jsem preformulovat

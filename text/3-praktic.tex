...
Jak již bylo řečeno výše, IPR svá data zveřejnil a stále zveřejňuje pod licencí
CC-BY SA 4.0 což uživateli umožňuje:
\begin{itemize}
    \item  .. něco
    \item  .. něco
\end{itemize}
...
bylo navrženo {\tt free for Prague citizens} , tedy zdarma pro občany Prahy.
...
Z dat OSM byly vyhledány body pomocí tohoto atributu
\begin{verbatim}
    amenity=park_ride
\end{verbatim}
...
Dále bylo vyzkoušeno hledání bodů s atributem {\tt park\_ride=yes} .
Byl nalezen pouze jeden prvek.

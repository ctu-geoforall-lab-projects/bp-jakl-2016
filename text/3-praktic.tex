...
V diskuzi byl navržen import výšek budov {\tt building:height~= }
ze~souboru dat Budovy 3D.
Dále bylo navrženo aby byl přidán atribut zdroje
\begin{verbatim}
    source:building:level =
\end{verbatim}
aby bylo možné později zdroj těchto dat identifikovat.
...
Dále tedy bylo možné k těmto prvkům přiřadit výšku podle hodnoty {\tt id\_bud},

...
vhodné a nevhodné je použít (dle komunity). Pokud se stane, že je použit 
...
\section{Opendata}
\label{opendata}
Základní myšlenka otevřených dat vznikla v USA, kde pokud vzniknou 
geografická data z veřejných peněz, měla by tedy být přístupná 
veřejně. Díky tomuto byly zprvu k dispozici satelitní snímky povrchu 
Země a digitální model terénu s rozlišením 30x30 m od NASA (pro 
pozdější vykreslení vrstevnic). Tento trend se začal rozšiřovat zprvu 
do západních Evropy. 
...
těchto uskupení je vyvíjen tlak na zveřejňování smluv s ..???.. a dat 
...
dnes čítá přes 10 milionů [??] registrovaných uživatelů a ..xx.. 
...
dat z OSM. Využívá aplikaci OpenLayers založenou na konceptu AJAX.
...
Existují další stránky jež se zabývají vykreslením různých dat. 
Například mapu turistických a cyklistických tras vykresluje mtbmap.cz 
a to pro celou Evropu.
